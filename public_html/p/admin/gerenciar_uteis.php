...
<div class="d-flex">
    <?php $paginaAtiva = 'uteis'; require '../includes/layout/admin_sidebar.php'; ?>
...
<div class="modal fade" id="modalAddRecurso" tabindex="-1" aria-labelledby="modalAddRecursoLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="gerenciar_uteis">
...
<form id="formDelete" method="POST" action="gerenciar_uteis">
